...
<h1>School Supplies Inventory System </h1>
<br>
</br>
<ol id="toc">
    <li><a href="#inventory"><span>Inventory</span></a></li>
	<li><a href="#addproitem"><span>Verify Product</span></a></li>
...
<div class="content" id="alert">
	...
	<?php
	$CRITICAL=10;
	$sql2=mysql_query("select * from inventory where qty_left<='$CRITICAL'");
...
<form action="updateproduct.php" method="post">
	...
	<br />
	Number of Item To Be Added:<input name="itemnumber" type="text" /><br />
